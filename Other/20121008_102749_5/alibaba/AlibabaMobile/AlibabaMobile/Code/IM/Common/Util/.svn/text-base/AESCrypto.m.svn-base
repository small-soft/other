...
-(NSData *)encryptText:(NSString *)text{
	...
	NSData *_secretData = [text dataUsingEncoding:NSUTF8StringEncoding];
	CCOptions padding = kCCOptionPKCS7Padding;
	//NSString *key = @"5212Vera";
	NSData *encryptedData = [self encrypt:_secretData key:[self md5data:encryptKey] padding:&padding];
	//NSString *result = [[NSString alloc] initWithData:encryptedData encoding:NSUTF8StringEncoding];
	//NSLog(@"The encrypt string is : %@ for text : %@", encryptedData, text);
...
-(NSString *)decryptText:(NSData *)encryptedData{
	...
	CCOptions padding = kCCOptionPKCS7Padding;
	//NSData *encryptedData = [text dataUsingEncoding:NSUTF8StringEncoding];
	NSData *data = [self decrypt:encryptedData key:[self md5data:encryptKey] padding:&padding];
