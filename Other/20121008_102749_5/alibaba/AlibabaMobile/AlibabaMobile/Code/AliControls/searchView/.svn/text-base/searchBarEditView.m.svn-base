...
@implementation searchBarEditView
...
+(id)createView
{
    NSArray *nib = [[NSBundle mainBundle] loadNibNamed:@"searchBarEditView" 
                                                 owner:self options:nil];
    for (id oneObject in nib)
    {
        if ([oneObject isKindOfClass:[searchBarEditView class]])
        {
            searchBarEditView *obj = (searchBarEditView *)oneObject;
            [obj setupView];
            return  obj;
        }
    }
