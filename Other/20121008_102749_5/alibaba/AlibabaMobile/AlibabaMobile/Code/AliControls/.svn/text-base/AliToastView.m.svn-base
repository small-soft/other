...
+ (AliToastView *)MakeToastWithType:(int)type info:(NSString *)text {
    AliToastView * toastView = [[[AliToastView alloc] initWithType:type text:text] autorelease];
