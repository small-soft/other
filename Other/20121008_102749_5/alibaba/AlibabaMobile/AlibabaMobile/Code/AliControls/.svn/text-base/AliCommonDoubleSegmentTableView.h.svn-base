...
@interface AliCommonDoubleSegmentTableView :  UIViewController <UITableViewDataSource,UITableViewDelegate,RKObjectLoaderDelegate,AliNavigationBackDelegate,AliNavigationButtonDelegate,AliSegmentedDelegate,UIAlertViewDelegate,AliRightBarButtonItemDelegate>{
