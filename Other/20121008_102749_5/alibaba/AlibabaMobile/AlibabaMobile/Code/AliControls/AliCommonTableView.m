...
NSInteger gLastDisplayErrorTimeInterval = 0;

#define RGB(r, g, b) [UIColor colorWithRed:r/255.0 green:g/255.0 blue:b/255.0 alpha:1.0]
@interface AliCommonTableView()
...
@implementation AliCommonTableView
...
-(void)viewWillDisappear:(BOOL)animated {
    if (self.mLoadingView.loadFailedView.hidden) {
...
-(UIView*)mLoadingView
{
    if (!_mLoadingView) {
        ...
        _mLoadingView.frame= CGRectMake(0,[self loadingStartY],_mLoadingView.frame.size.width,_mLoadingView.frame.size.height);
