//
//  AMPrecisionVisitorDetailRequest.m
//  AlibabaMobile
//
...
@implementation AMPrecisionVisitorDetailRequest
...
- (id) init {
    if (self = [super init]) {
        self.requestURL = OCEAN_API_URL_PRECISION_VISITOR_DETAIL;
    }
    return self;
}
...
- (NSData*)HTTPBody {
    ...
    if ((self.transactionType == (int)AMTRANSACTION_TYPE_PRECISION_VISITOR_DETAIL)){
    ...
    RKObjectMapping* requestMapping = [RKObjectMapping mappingForClass:[AMPrecisionVisitorDetailRequest class]];
    ...
    NSLog(@"AMPrecisionVisitorDetailRequest URL = %@", signedBodyString);
