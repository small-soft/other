//
//  AMPrecisionTalkPermissionRequest.m
//  AlibabaMobile
//
...
@implementation AMPrecisionTalkPermissionRequest
...
- (id) init {
    if (self = [super init]) {
        self.requestURL = OCEAN_API_URL_PRECISION_TALK_PERMISSION;
    }
    return self;
}
...
- (NSData*)HTTPBody {
    ...
    if ((self.transactionType == (int)AMTRANSACTION_TYPE_PRECISION_TALK_PERMISSION)){
    ...
    RKObjectMapping* requestMapping = [RKObjectMapping mappingForClass:[AMPrecisionTalkPermissionRequest class]];
