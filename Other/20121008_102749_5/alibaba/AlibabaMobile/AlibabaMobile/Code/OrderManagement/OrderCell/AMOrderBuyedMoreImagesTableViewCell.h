//
//  AMOrderBuyedMoreImagesTableViewCell.h
//  AlibabaMobile
//
...
#define ALI_TABLEVIEW_ORDER_MORE_IMAGE_CELL_HEIGHT 260

@interface AMOrderBuyedMoreImagesTableViewCell : UITableViewCell
