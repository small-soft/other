 ...
 */
CSTL_API int8_t push_front_List(List * list, void *obj, size_t objsize, int flag);
 ...
 * @return 0 on success, non-zero on failure
 */
CSTL_API int8_t push_back_List(List * list, void *obj, size_t objsize, int flag);
 ...
 * @return 0 on success, non-zero on failure
 */
CSTL_API int8_t pop_front_List(List * list);
 ...
 * @return 0 on success, non-zero on failure
 */
CSTL_API int8_t pop_back_List(List * list);
 ...
 */
CSTL_API void *front_List(List * list);
 ...
 * @return pointer to obj on success, NULL otherwise
 */
CSTL_API void *back_List(List * list);
 ...
 */
CSTL_API void *insert_List(List * list, void *obj, size_t objsize, int flag);
 ...
 */
CSTL_API int8_t delete_List(List * list, void *obj, size_t objsize);
 ...
 */
CSTL_API int8_t sort_List(List * list, size_t objsize);
 ...
 * @return 0 on success, non-zero on error
 */
CSTL_API int8_t rsort_List(List * list, size_t objsize);
 ...
 */
CSTL_API void *find_List(List * list, void *obj, size_t objsize);
...
/**
  ...
  */
CSTL_API void *to_array_List(List * list, size_t objsize);
...
/**
  ...
  */
CSTL_API ITER(List) * extract_ListIter(ITER(List) * iter);
