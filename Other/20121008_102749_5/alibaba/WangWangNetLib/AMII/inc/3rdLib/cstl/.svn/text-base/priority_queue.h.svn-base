 ...
 */
CSTL_API int8_t insert_PrioQueue(PrioQueue *obj,int32_t priority,void* data, size_t datasize);
 ...
 */
CSTL_API void *top_data_PrioQueue(PrioQueue* obj);
/**
 ...
 * @return 0 on success, non-zero on error
 */
CSTL_API int8_t inc_prio_PrioQueue(PrioQueue *obj,int32_t amt,void *data, size_t datasize);
/**
 * @param obj the object that contains the data
 ...
 * @return 0 on success, non-zero on error
 */
CSTL_API int8_t dec_prio_PrioQueue(PrioQueue *obj,int32_t amt,void *data, size_t datasize);
/**
 ...
 */
CSTL_API int32_t find_prio_PrioQueue(PrioQueue *obj, void *data, size_t datasize);
/**
...
CSTL_API int8_t resize_PrioQueue(PrioQueue *obj,size_t size);
#ifdef __cplusplus
}
#endif
#endif
