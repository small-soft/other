 ...
 */
CSTL_API int8_t insert_at_Vector(Vector * vec, void *obj, uint32_t loc);
 ...
 */
CSTL_API int8_t insert_Vector(Vector * vec, void *obj,size_t objsize, int flag);
CSTL_API int8_t push_back_Vector(Vector *vec, void *obj, size_t objsize, int flag);
CSTL_API int8_t push_front_Vector(Vector *vec, void *obj, size_t objsize, int flag);
CSTL_API int8_t pop_back_Vector(Vector *vec);
CSTL_API int8_t pop_front_Vector(Vector *vec);
CSTL_API void *front_Vector(Vector *vec);
CSTL_API void *back_Vector(Vector *vec);
 ...
 * point
 */
CSTL_API void *return_at_Vector(Vector * vec, uint32_t loc);
 ...
 */
CSTL_API int8_t resize_Vector(Vector * vec, size_t size);
