 ...
 */
CSTL_API int8_t insert_Heap(Heap *obj, void *data, size_t datasize, int flag);
 ...
 * delete call
 */
CSTL_API void *top_Heap(Heap *obj);
 ...
 */
CSTL_API int8_t pop_Heap(Heap* obj);
 ...
 * @return 0 on success, non-zero on error
 */
CSTL_API int8_t merge_Heap(Heap* obj, Heap* src);
 ...
 * @return 0 on success, non-zero on error
 */
CSTL_API int8_t resize_Heap(Heap* obj, size_t size);
#ifdef __cplusplus
}
#endif
#endif
