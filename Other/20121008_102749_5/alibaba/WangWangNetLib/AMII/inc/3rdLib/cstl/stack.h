 ...
 */
CSTL_API int8_t push_StackList(StackList * stack, void *obj, size_t objsize,
                             int8_t flag);
 ...
 */
CSTL_API int8_t pop_StackList(StackList * stack);
 ...
 */
CSTL_API void *top_StackList(StackList * stack);
...
CSTL_API int8_t pop_StackVector(StackVector *stack);
CSTL_API void * top_StackVector(StackVector *stack);
CSTL_API int8_t push_StackVector(StackVector *stack, void *obj, size_t objsize, int flag);
CSTL_API int8_t resize_StackVector(StackVector *stack,size_t size);
