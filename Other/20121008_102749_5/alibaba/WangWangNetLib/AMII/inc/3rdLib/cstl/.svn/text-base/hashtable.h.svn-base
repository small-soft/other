...
CSTL_API int8_t insert_OHTable(OHTable *table, void *element, size_t elesize,int8_t flag);
CSTL_API int8_t delete_OHTable(OHTable *table, void *element, size_t elesize);
CSTL_API void *find_OHTable(OHTable *table, void *element, size_t elesize);
CSTL_API int8_t set_hash_OHTable(OHTable *table, uint32_t (*hash)(void *,size_t));
...
CSTL_API int8_t insert_CHTable(CHTable *table, void *element, size_t elesize,int8_t flag);
CSTL_API int8_t delete_CHTable(CHTable *table, void *element, size_t elesize);
CSTL_API void *find_CHTable(CHTable *table, void *element, size_t elesize);
CSTL_API int8_t set_hash_CHTable(CHTable *table, int32_t (*hash)(void *,size_t));
CSTL_API int8_t set_probe_CHTable(CHTable *table, uint32_t (*prob)(uint32_t));
...
CSTL_API uint32_t char_hash(void *key, size_t len);
CSTL_API uint32_t num_hash(void *key, size_t len);
/* Generic probing techniques */
CSTL_API uint32_t linear_probing(uint32_t num);
CSTL_API uint32_t quadratic_probing(uint32_t num);
#ifdef __cplusplus
}
#endif
