...
#if defined(_WIN32)
   #ifdef CSTL_DLL_EXPORT
        #define CSTL_API __declspec(dllexport)
   #else
        #define CSTL_API
   #endif
#else
...
#ifdef AMOS_DEBUG
#define F_CONSTRUCT_FUNC_ALLOC void *(*alloc) (size_t, const char*, int),
#else
#define F_CONSTRUCT_FUNC_ALLOC void *(*alloc) (size_t),
#endif

#define F_CONSTRUCT_FUNC(TYPE)\
	int8_t construct_func_##TYPE(TYPE* obj, size_t datasize, int flag,\
                             F_CONSTRUCT_FUNC_ALLOC \
                             void (*dealloc) (void *),\
...
#define F_SET_ALLOC(TYPE)\
	int8_t set_alloc_##TYPE(TYPE* obj, void* (*alloc) (size_t, const char*, int))
#else
#define F_SET_ALLOC(TYPE)\
