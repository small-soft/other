 ...
 */
 CSTL_API int8_t pop_QueueList(QueueList * queue);
 ...
 * easily referenced
 */
 CSTL_API void *front_QueueList(QueueList * queue);
 ...
 */
 CSTL_API int8_t push_QueueList(QueueList * queue, void *obj, size_t objsize,
                         int flag);
...
CSTL_API int8_t pop_QueueVector(QueueVector *queue);
CSTL_API void * front_QueueVector(QueueVector *queue);
CSTL_API int8_t push_QueueVector(QueueVector *queue, void *obj, size_t objsize, int flag);
CSTL_API int8_t resize_QueueVector(QueueVector *queue,size_t size);
