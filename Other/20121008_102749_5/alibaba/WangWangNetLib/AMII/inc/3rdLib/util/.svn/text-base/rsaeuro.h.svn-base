...
UTIL_API int R_GeneratePEMKeys PROTO_LIST ((R_RSA_PUBLIC_KEY *, R_RSA_PRIVATE_KEY *,
...
#else
UTIL_API void R_memset PROTO_LIST ((POINTER, int, unsigned int));
UTIL_API void R_memcpy PROTO_LIST ((POINTER, POINTER, unsigned int));
UTIL_API int R_memcmp PROTO_LIST ((POINTER, POINTER, unsigned int));
#endif
