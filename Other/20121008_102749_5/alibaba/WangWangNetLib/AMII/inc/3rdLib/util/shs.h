...
UTIL_API void SHSInit PROTO_LIST ((SHS_CTX *));
UTIL_API void SHSUpdate PROTO_LIST ((SHS_CTX *, unsigned char *, int ));
UTIL_API void SHSFinal PROTO_LIST ((unsigned char *, SHS_CTX *));
