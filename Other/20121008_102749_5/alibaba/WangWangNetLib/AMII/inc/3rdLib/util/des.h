...
UTIL_API void DES_CBCInit PROTO_LIST 
  ((DES_CBC_CTX *, unsigned char *, unsigned char *, int));
UTIL_API int DES_CBCUpdate PROTO_LIST
  ((DES_CBC_CTX *, unsigned char *, unsigned char *, unsigned int));
UTIL_API void DES_CBCRestart PROTO_LIST ((DES_CBC_CTX *));

UTIL_API void DESX_CBCInit PROTO_LIST
  ((DESX_CBC_CTX *, unsigned char *, unsigned char *, int));
UTIL_API int DESX_CBCUpdate PROTO_LIST
  ((DESX_CBC_CTX *, unsigned char *, unsigned char *, unsigned int));
UTIL_API void DESX_CBCRestart PROTO_LIST ((DESX_CBC_CTX *));

UTIL_API void DES3_CBCInit PROTO_LIST 
  ((DES3_CBC_CTX *, unsigned char *, unsigned char *, int));
UTIL_API int DES3_CBCUpdate PROTO_LIST
  ((DES3_CBC_CTX *, unsigned char *, unsigned char *, unsigned int));
UTIL_API void DES3_CBCRestart PROTO_LIST ((DES3_CBC_CTX *));
