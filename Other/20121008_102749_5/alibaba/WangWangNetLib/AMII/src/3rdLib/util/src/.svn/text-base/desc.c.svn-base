...
UTIL_API void DES_CBCInit(context, key, iv, encrypt)
...
*/
UTIL_API int DES_CBCUpdate(context, output, input, len)
DES_CBC_CTX *context;           /* context */
...
UTIL_API void DES_CBCRestart(context)
DES_CBC_CTX *context;                                                                           /* context */
{
...
*/
UTIL_API void DESX_CBCInit(context, key, iv, encrypt)
...
UTIL_API int DESX_CBCUpdate (context, output, input, len)
DESX_CBC_CTX *context;          /* context */
unsigned char *output;          /* output block */
unsigned char *input;           /* input block */
unsigned int len;               /* length of input and output blocks */
...
UTIL_API void DESX_CBCRestart(context)
DESX_CBC_CTX *context;          /* context */
{
	/* Restore the original IV */
	*context->iv = *context->originalIV;
...
UTIL_API void DES3_CBCInit(context, key, iv, encrypt)
...
UTIL_API int DES3_CBCUpdate(context, output, input, len)
DES3_CBC_CTX *context;          /* context */
unsigned char *output;          /* output block */
unsigned char *input;           /* input block */
unsigned int len;               /* length of input and output blocks */
...
UTIL_API void DES3_CBCRestart (context)
DES3_CBC_CTX *context;          /* context */
{
	/* Restore the original IV */
	*context->iv = *context->originalIV;
